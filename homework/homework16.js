...
function toInitials(str) {
  ...
  const lastNameInitial = fullName[1].charAt(0).toUpperCase()
...
function reverse(str){
  const reserstWords = str.split('').reverse().join('')
...
/**
 * Requirement:
Write a function named reverseWords() which takes a string argument and returns a string with
 each word within that string reversed but still in the same order as the initial string. 
