// Task 1
console.log('I start to practice "JavaSkript" today, and i like it.');
...
console.log('You can waste your lives drawing lines. Or you canlive your life crossing them.');
...
console.log(`The averege of the numbers is:`+ average1 );
//Or other way
console.log('The averege of the numbers is:' + ((i1 +i2) / 2));
...
console.log(`The averege of the numbers is:` + average2)
//Or other way
console.log('The averege of the numbers is:' + ((a1 + a2 + a3 + a4 + a5) / 5 ));
...
console.log(`The 5 multiplied with 5 is = ${5 * 5}`);
console.log(`The 6 multiplied with 6 is = ${6 * 6}`);
console.log(`The 10 multiplied with 10 is = ${10 * 10}`);
...
//Task 11
   ...
   //Task 12
    ...
    console.log(`        User who joned this program is ${firstName} ${lastName}.John's age is ${age}.
